		...
		<div id="content">
			...
			<?php
                ...
                while($row1 = mysqli_fetch_array($result1)){
                    ...
                    $sql3 = "SELECT COUNT(IdKeputusan) AS 'SumKeputusan' FROM keputusan 
                    WHERE IdMurid = '$row1[IdMurid]'";
                    $result3 = mysqli_query($conn, $sql3);
                    $row3 = mysqli_fetch_array($result3);
                    $totalSoalan = $row3['SumKeputusan'];
                    $sql4 = "SELECT COUNT(Kebenaran) AS 'SumCorrect' FROM keputusan 
                    WHERE IdMurid='$row1[IdMurid]' AND Kebenaran='betul'";
