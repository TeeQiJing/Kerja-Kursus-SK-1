<?php
    ...
    <div id="title">
		...
		<div id="list-div">
			<img src="Bulleted-List-icon.png" alt="menu" id="menu-btn" onclick="openNav()">
		</div>';
	...
	if(empty($_SESSION["Status"])){
		...
		<div id="menu-sidenav" class="sidenav">
			...
			<img src="authorName.png" alt="author-name" id="authorName" width=200px height=80px>
			<ul>
				<li>
					<a id="LamanUtama" href="http://localhost/Kerja%20Kursus%20SK%201/LamanUtama.php">Laman Utama</a>
				</li>
				<li>
					...
					<ul>
						...
						<li>
							<img src="right-arrow-icon.png" id="rightArrow">
		...
		<div id="menu-sidenav" class="sidenav">
			<a href="javascript: void(0)" class="closebtn" onclick="closeNav()">&times;</a>
			<img src="authorName.png" alt="author-name" id="authorName" width=200px height=70px>
			<ul>
				<li>
					<a id="LamanUtama" href="http://localhost/Kerja%20Kursus%20SK%201/LamanUtama.php">Laman Utama</a>
				</li>
				...
				<!--<li>
					<a id="Kuiz" href="http://localhost/Kerja%20Kursus%20SK%201/Pilih.php">Kuiz</a>
				</li>-->

				<li>
					<a id="Laporan" href="http://localhost/Kerja%20Kursus%20SK%201/Laporan.php">Laporan</a>
				</li>

				<li>
					<a id="Import" href="http://localhost/Kerja%20Kursus%20SK%201/Import.php">Import</a>
				</li>
				...
				<li>
					<a id="LogOut" href="http://localhost/Kerja%20Kursus%20SK%201/LogKeluar.php">Log Keluar</a>
				</li> 
			</ul>
		</div>
	</div>';
